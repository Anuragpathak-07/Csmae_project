    ...
    <div className="mx-4 mt-4">
      <div className="glass-panel flex flex-wrap items-center gap-2 px-4 py-3">
        {FILTERS.map((f) => (
          <button
            key={f.key}
            className="flex items-center gap-2 rounded-full border border-border-subtle bg-black/30 px-3 py-1.5 text-xs text-text-secondary transition hover:border-accent-secondary/40 hover:text-text-primary"
          >
        ...
        <div className="ml-auto flex items-center gap-2">
          <button className="flex items-center gap-1.5 rounded-full border border-border-subtle bg-black/30 px-3 py-1.5 text-xs text-text-secondary transition hover:text-text-primary">
            Saved Views <ChevronDown className="h-3 w-3" />
          </button>
          <button aria-label="Favorite" className="rounded-full border border-border-subtle bg-black/30 p-1.5 text-text-secondary transition hover:text-status-watchlist">
            <Star className="h-3.5 w-3.5" />
          </button>
          <button
            onClick={() => setChips([])}
            className="flex items-center gap-1.5 rounded-full border border-border-subtle bg-black/30 px-3 py-1.5 text-xs text-text-secondary transition hover:text-text-primary"
          >
